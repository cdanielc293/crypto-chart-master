        ...
        >
          ...
          {!showEmailForm && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 px-4 py-3.5 rounded-lg border border-cyan-400/30 bg-cyan-400/10 hover:bg-cyan-400/15 transition-colors text-sm font-semibold text-white"
            >
          ...
          <div className="space-y-2.5">
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-lg border border-white/10 bg-white/[0.02] text-white/30 text-sm font-semibold cursor-not-allowed relative"
            >
              ...
              <span className="ml-auto text-[10px] px-2 py-0.5 rounded-full bg-white/5 border border-white/10 text-white/30 uppercase tracking-wider font-bold">Coming Soon</span>
            </button>
