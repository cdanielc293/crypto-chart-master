...
import { ArrowLeft, CheckCircle, AlertTriangle, XCircle, Clock, Wrench, Mail } from 'lucide-react';
import vizionLogo from '@/assets/vizionx-logo.png';
import { useState } from 'react';

const services = [
  { name: 'Website', status: 'operational' },
  { name: 'Data Feeds', status: 'operational' },
...
// Generate last 90 days status (all healthy for now)
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white/80">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        {/* Overall Status */}
        <div className={`text-center mb-12 p-6 rounded-2xl border ${allOperational ? 'border-emerald-500/20 bg-emerald-500/5' : 'border-yellow-500/20 bg-yellow-500/5'}`}>
          {allOperational ? (
        ...
        <section className="text-center py-8 border-t border-white/10">
          ...
          <p className="text-sm text-white/50 max-w-lg mx-auto mb-4">
            We continuously monitor the status of VizionX and all related services. 
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
            <a
              href="mailto:support@vizionx.pro"
